...
import {
  ...
  AccordionItemState,
  PartialAccordionItemState,
} from './AccordionItem.types';
import { useCreateAccordionItemContext } from './useAccordionItemContext';

const mergeProps = makeMergeProps<PartialAccordionItemState>({ deepMerge: accordionItemShorthandProps });
...
export const useAccordionItem = (
  ...
  return Object.assign(state, { context: useCreateAccordionItemContext(state) });
};
