...
const CalendarChat = PlaceholderIcon; // bundleIcon(CalendarChatFilled, CalendarChatRegular);
const CalendarDay = PlaceholderIcon; //bundleIcon(CalendarDayFilled, CalendarDayRegular);
const CalendarMonth = PlaceholderIcon; //bundleIcon(CalendarMonthFilled, CalendarMonthRegular);
const CalendarSearch = PlaceholderIcon; //bundleIcon(CalendarSearchFilled, CalendarSearchRegular);
const CalendarToday = PlaceholderIcon; //bundleIcon(CalendarTodayFilled, CalendarTodayRegular);
const CalendarWeekStart = PlaceholderIcon; //bundleIcon(CalendarWeekStartFilled, CalendarWeekStartRegular);
const CalendarWorkWeek = PlaceholderIcon; //bundleIcon(CalendarWorkWeekFilled, CalendarWorkWeekRegular);
const MoreHorizontal = PlaceholderIcon; //bundleIcon(MoreHorizontalFilled, MoreHorizontalRegular);
